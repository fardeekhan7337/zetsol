                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cat_id" id="cat_id" class="form-control">
                                        ...
                                        @foreach ($categories as $cat)
                                            ...
                                            <option value="{{ $cat->id }}"  {{ old('cat_id') == $cat->id || $product->cat_id == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="price" step="any" name="price" value="{{ old('price') ?? $product->price }}" />
                                    @error('price')
                                        <div class="error-message">{{ $message }}</div>
                                    @enderror
                                </div>
